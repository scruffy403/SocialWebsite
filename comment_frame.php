      ...
      if ($count != 0) {
        while ($comment = mysqli_fetch_array($get_comments)) {
          ...
          <div class="comment_section">
            <a href="<?php echo $posted_by ?>" target="_parent"> <img src="<?php echo $user_object->getProfilePic(); ?>" title="<?php echo $posted_by; ?>" style="float:left;" height="30"> </a>
            <a href="<?php echo $posted_by ?>" target="_parent"> <b><?php echo $user_object->getFirstAndLastName(); ?></b> </a>
