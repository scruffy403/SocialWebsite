...
class Notification {
  ...
  public function getNotifications($data, $limit) {
    ...
    $set_viewed_query = mysqli_query($this->connection, "UPDATE notifications
    ...
    $number_iterations = 0; // Number of messages checked
    $count = 1; // Number of messages posted

    while($row = mysqli_fetch_array($query)) {
      if($number_iterations++ < $start)
        continue;
  ...
  public function insertNotification($post_id, $user_to, $type) {
    ...
    $insert_query = mysqli_query($this->connection, "INSERT INTO notifications(id, user_to, user_from, message, link, datetime, opened, viewed) VALUES(NULL, '$user_to', '$userLoggedIn', '$message', '$link', '$date_time', 'no', 'no')");
